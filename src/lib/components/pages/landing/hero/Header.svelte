...
<div class="smScreenHeading md:mdxlScreenHeading px-[0.938rem] md:px-[2.5rem] xl:px-[22.5rem] text-center py-[4rem] md:py-[8rem]">
  <p>{HeaderData.headerText[0].children[0].text}</p>
</div>
